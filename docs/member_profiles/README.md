...
- 역할 변경 시 해당 팀원 문서와 공통 요약 문서의 역할 표기를 함께 갱신한다.

## Files
- `S.md`: 팀장, 하드웨어 제작/조립, 실험 진행 지원, 기획 단계 동역학/진동 분석
- `L.md`: 시스템 통합, 가상센싱
- `Y.md`: Arduino 제어, 회로 구성/배선, 전원 및 구동계 연결
- `T.md`: 하드웨어 제작/조립, 기구 설계, 제작 치수 검토
- `N.md`: 하드웨어 제작/조립, 프로파일 주문제작 요청, 기획 단계 구조/응력 해석
